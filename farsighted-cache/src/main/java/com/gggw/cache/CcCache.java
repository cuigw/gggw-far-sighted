...
public class CcCache {
    ...
    private final static Logger log = LoggerFactory.getLogger(CcCache.class);

    private final static String CONFIG_FILE = "/cache/j2cache.properties";
    ...
    private static Properties loadConfig() throws IOException {
        ...
        InputStream configStream = CcCache.class.getClassLoader().getParent().getResourceAsStream(CONFIG_FILE);
